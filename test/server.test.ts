        ...
        await t.test('Server responds to endpoints', async (t) => {
            ...
            await t.test('Server View API passes all units', async (t) => {
                ...
                await t.test('View API responds to /img/test.png', async (t) => {
                    ...
                    assert.strictEqual(bytes.byteLength, testPngBytes.length, 'Number of byts differs');
            ...
            await t.test('Server Manage API passes all units', async (t) => {
                ...
                await t.test('Manage API reject with no auth header', async (t) => {
                    ...
                    let req : RequestInit = { 
                        ...
                        body : JSON.stringify(await getMediaBinary('test.png'))
                    }
                ...
                await t.test('Manage API accept with valid auth header', async (t) => {
                    ...
                    let media = await getMediaBinaryDto('test.png');
